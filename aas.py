...
def app():
    st.title('Team AAweSome 2022')
    password = 'a&as22/23'
    intro = st.empty()
    intro.markdown('This page is only available to Team AAweSome 2022 managers')
    text_input_container = st.empty()
    vml_pass = text_input_container.text_input('Insert password below:', type='password',
                                               help='If you are in the Team AAweSome 2022 league and' +
    ...
    if vml_pass == password:
        ...
        st.markdown('The table below gives general information of all managers in Team AAweSome 2022 (TAA22):')
        ...
        if len(wildcard_df.index) == 0:
            ...
            st.markdown('The table below shows when different wild card chips have been played as well' +
                        ...
                        'was activated. It also indicates what the FPL average and TAA22 average was for the ' +
        ...
        if len(freehit_df.index) == 0:
            ...
            st.markdown('The table below shows when different free hit chips have been played as well' +
                        ...
                        'FPL average and TAA22 ' + 'average was for the GW the chip was played and ' +
